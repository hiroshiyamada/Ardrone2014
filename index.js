    ...
    drone.move = function(control) {
      ...
      if (drone.isIddle()) {
        drone.stop();
      	...
      	control.x = gFace.x - gcam_width/2;
      	//control.y = gFace. - gcam_width/2;
      	control.z = -(gFace.y - gcam_height/2);
      	console.log("control.x = %d",control.x);
      	console.log("control.z = %d",control.z);
